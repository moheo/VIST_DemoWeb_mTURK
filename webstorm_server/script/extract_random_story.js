...
let s2t_list0 = fs.readFileSync('data/glacnet_splits/glacnet_normtxt_spl_0.json');
let s2t_list1 = fs.readFileSync('data/glacnet_splits/glacnet_normtxt_spl_1.json');
let s2t_list2 = fs.readFileSync('data/glacnet_splits/glacnet_normtxt_spl_2.json');
let s2t_list3 = fs.readFileSync('data/glacnet_splits/glacnet_normtxt_spl_3.json');
let s2t_list4 = fs.readFileSync('data/glacnet_splits/glacnet_normtxt_spl_4.json');
