...
let s2t_list0 = fs.readFileSync('data/human_splits/human_normtxt_spl_0.json');
let s2t_list1 = fs.readFileSync('data/human_splits/human_normtxt_spl_1.json');
let s2t_list2 = fs.readFileSync('data/human_splits/human_normtxt_spl_2.json');
let s2t_list3 = fs.readFileSync('data/human_splits/human_normtxt_spl_3.json');
let s2t_list4 = fs.readFileSync('data/human_splits/human_normtxt_spl_4.json');
...
exports.get_random_item = () => {
    ...
    photos0 = photos0.map((p_id) => {
        return 'http://147.46.216.59:33003/images/test/' + p_id + '.jpg'});
